...
public class MainPersonaList {
	
	private static final int NUM_PERSONAS = 3;
	
	public static Persona obtenerMayorEdad (ArrayList<Persona> array_p)
	{
		...
		for (int j=0; j<array_p.size(); j++)
		{
			persona_en_curso = array_p.get(j);
	...
	public static void mostrarArrayPersonas (ArrayList<Persona> array_p)
	{
